...
lc_srv_loc="/usr/local/etc/lancache"
# Primary DNS Server
lc_dns1="8.8.8.8"
...
lc_nginx_loc="/usr/local/etc/nginx"
lc_unbound_loc="/usr/local/etc/unbound"
lc_netdata="/usr/local/etc/netdata/netdata.conf"
...
pkg install nginx sniproxy unbound httpry netdata git
# Arrays used
